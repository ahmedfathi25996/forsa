...
trait imagesTrait
{
    ...
    )
    {
        ...
        $upload_img = $this->cms_upload($request,($this->user_id ?? 1),$img_file_name,$upload_file_path,$width,$height,$ext_arr);
    ...
    )
    {
        ...
        //upload new files
        $slider_file    = $this->cms_upload($request , ($this->user_id ?? 1),"$field_name", $folder = "$path", $width, $height);//array
