...
class redeem_rules_m extends Model
{
    use SoftDeletes;

    protected $table        = "redeem_rules";
    ...
    protected $fillable     =
        [
            'redeem_money','redeem_points'
        ];


    static function get_redeem_rules(
    ...
    {
        $results = redeem_rules_m::select(DB::raw("
            redeem_rules.*
