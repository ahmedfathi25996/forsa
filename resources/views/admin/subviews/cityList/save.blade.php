...
@section('subview')
    ...
    <?php
        ...
        if (is_object($item_data)) {
            $header_text    = $item_data->city_name;
        ...
        <div class="container">
            <div class="slim-pageheader">
                <ol class="breadcrumb slim-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url("admin/cityList")}}">المدن</a></li>
            ...
            <div class="section-wrapper">
                ...
                <div class="table-wrapper">
                    ...
                    <form id="save_form" action="{{url("admin/cityList/save/$city_id")}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <section>
                                                ...
                                                <div class="row">
                                                    <?php
                                                        ...
                                                        $attrs[0]["city_name"] = 'الإسم'.$required_sign;
