        ...
        <div class="container">
            <div class="slim-pageheader">
                <ol class="breadcrumb slim-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url("admin/days")}}">الأيام</a></li>
            ...
            <div class="section-wrapper">
                ...
                <div class="table-wrapper">
                    ...
                    <form id="save_form" action="{{url("admin/days/save/$day_id")}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <section>
                                                ...
                                                <div class="row">
                                                    <?php
                                                        ...
                                                        $attrs[0]["day_name"] = 'الإسم'.$required_sign;
