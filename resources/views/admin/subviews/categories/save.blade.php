...
@section('subview')
    ...
    if (is_object($item_data)) {
        $header_text            = $item_data->cat_name;
        $cat_id      = $item_data->cat_id;
        $parent_id=$item_data->parent_cat_id;
        ...
        <div class="container">
            ...
            <div class="section-wrapper">
                ...
                <div class="table-wrapper">
                    ...
                    <form id="save_form" action="{{url("admin/category/save_cat/$cat_type/$cat_id")}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="section-wrapper mg-t-20">
                                    ...
                                    <label class="section-title">اللون</label>
                                    <p class="mg-b-20 mg-sm-b-40"></p>
                                    ...
                                    <div class="row">
                                        ...
                                        $attrs          = generate_default_array_inputs_html(
                                            ...
                                            $required           = "",
                                            $grid_default_value = 2
                                        );


                                        $attrs[0]["color"]                  = '  لون خلفية القسم';
                                        $attrs[3]["color"]                  = "color";
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div id="wizard6">
                                        ...
                                        <section>
                                            <div class="row">
                                                ...
                                                $attrs[0]["cat_name"] = 'الإسم'.$required_sign;
                                                $attrs[0]["cat_short_desc"] = 'الملخص';
                                                $attrs[3]["cat_short_desc"]="textarea";
                                                $attrs[6]["cat_short_desc"]=12;
                                ...
                                <div class="section-wrapper mg-t-20">
                                    ...
                                    <div class="row">
                                        <?php
                                        $img_obj                    = $item_data->cat_img_id ?? "";

                                        echo generate_img_tags_for_form(
                                            $filed_name             = "cat_img_file",
                                            $filed_label            = "cat_img_file",
                                            $required_field         = " accept='image/*' ",
                                            $checkbox_field_name    = "cat_checkbox",
                                            $need_alt_title         = "no",
