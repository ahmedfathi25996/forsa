                            ...
                            <?php foreach ($results as $key => $item): ?>
                                <tr id="row{{$item->district_id}}">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary mg-b-6" href="{{url("admin/districtList/save/$item->district_id")}}">
                                        ...
                                        <a href='#confirmModal'
                                           ...
                                           data-tablename="App\models\district\district_list_m"
                                           data-deleteurl="{{url("/admin/districtList/delete")}}"
                                           data-itemid="{{$item->district_id}}">
