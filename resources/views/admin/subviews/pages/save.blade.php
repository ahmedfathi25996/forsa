...
@section('subview')
    ...
    <?php
        ...
        if (is_object($item_data)) {
            $header_text    = $item_data->page_title;
        ...
        <div class="container">
            <div class="slim-pageheader">
                <ol class="breadcrumb slim-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url("admin/pages")}}">الصفحات</a></li>
            ...
            <div class="section-wrapper">
                ...
                <div class="table-wrapper">
                    ...
                    <form id="save_form" action="{{url("admin/pages/save/$page_id")}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div id="wizard6">
                                        ...
                                        <section>
                                            <div class="row">
                                                ...
                                                $attrs[0]["page_title"] = 'الإسم'.$required_sign;
                                                $attrs[0]["page_slug"]  = 'اللينك'.$required_sign;
                                                $attrs[0]["page_body"]  = 'المحتوي'.$required_sign;
                                                $attrs[3]["page_body"]  ="textarea";
                                                $attrs[6]["page_body"]  ="12";
                                                $attrs[5]["page_body"]  .= ' summernote';
                                ...
                                <div class="section-wrapper mg-t-20">
                                    ...
                                    <div class="row">
                                        ...
                                        echo generate_img_tags_for_form(
                                            ...
                                            $display_label          = "إرفع صورة الصفحة",
                                            $img_obj,
                                            $grid                   = "col-md-6"
                                        );
                                        ?>
