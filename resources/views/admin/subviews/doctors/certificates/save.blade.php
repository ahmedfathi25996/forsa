        ...
        <div class="container">
            <div class="slim-pageheader">
                <ol class="breadcrumb slim-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url("admin/doctors/$doctor_id/certificates")}}">الشهادات</a></li>
                </ol>
            ...
            <div class="section-wrapper">
                ...
                <div class="table-wrapper">
                    ...
                    <form id="save_form" action="{{url("admin/doctors/$doctor_id/certificates/save/$cer_id")}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div id="wizard6">
                                        ...
                                        <section>
                                            ...
                                            <div class="row">
                                                ...
                                                $attrs[0]["title"] = 'الشهادة'.$required_sign;
                                                $attrs[3]["title"] = "textarea";
