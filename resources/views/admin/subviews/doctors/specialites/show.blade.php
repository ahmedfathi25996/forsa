                ...
                <div class="table-wrapper">
                    ...
                    <table id="datatable2" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-15p"><span>التخصص</span></th>
                            <th class="wd-15p"><span>العملية</span></th>
                        </tr>
                        </thead>
                        <tbody id="sortable">
                        <?php foreach ($results as $key => $item): ?>
                        <tr id="row{{$item->doc_spe_id}}" data-fieldname="social_order"
                            data-itemid="<?= $item->doc_spe_id ?>" data-tablename="App\models\doctors\doctors_specialites_m">
                            <td>
                                {{$key+1}}
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary mg-b-6" href="{{url("admin/doctors/$doctor_id/spec/save/$item->doc_spe_id")}}">
                                ...
                                <a href='#confirmModal'
                                   ...
                                   data-deleteurl="{{url("/admin/doctors/$doctor_id/spec/delete")}}"
                                   data-itemid="{{$item->doc_spe_id}}">
