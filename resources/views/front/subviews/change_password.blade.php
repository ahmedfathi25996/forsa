            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <form action="{{url("/change_password")}}" method="post">
                        ...
                        <label for="search"><i class="fa fa-key" aria-hidden="true"></i></label><br>

                        <input type="password" class="password_confirm" name="confirm_password" placeholder="Confirm Password">
                        <label for="search"><i class="fa fa-key" aria-hidden="true"></i></label><br>
                        {{csrf_field()}}
                        <button id="submit" type="submit"
                                class="register_btn col-md-4 col-md-offset-4 btn btn-primary btn-lg"
